...
description: >
  ...
  and explicitly create one unpublished draft from a Word document, or safely
...
1. Run `wxcli --version`. If the command is missing, report that wxcli is not on
   `PATH`; do not invent an install command.
